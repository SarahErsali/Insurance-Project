...
def render_tab2():
    ...
    return html.Div([
        html.H2("Key metrics and correlation analysis of the dataset based on line of business", style={'textAlign': 'left','marginBottom': '20px', 'fontSize': '30px', 'marginTop': '3cm'}),
